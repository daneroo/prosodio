...
const FIXTURE_DIR = join(config.appTestFixturesDir, "parser-outputs");
...
const INVALID_CASES: ReadonlyArray<readonly [string, unknown]> = [
  ...
  [
    "opened carrying openFailure",
    {
      ...
      content: {
        metadata: { title: "T", creator: "C", date: null },
        spine: [],
        manifest: [],
        spineHashes: [],
        toc: [],
  ...
  [
    "extra metadata field (out-of-v1)",
    {
      ...
      content: {
        metadata: { title: "T", creator: "C", date: null, language: "en" },
        spine: [],
        manifest: [],
        spineHashes: [],
        toc: [],
  ...
  [
    "metadata field of wrong type",
    {
      ...
      content: {
        metadata: { title: 42, creator: "C", date: null },
        spine: [],
        manifest: [],
        spineHashes: [],
        toc: [],
...
describe("parserOutputSchema — accepted edge cases", () => {
  test("all three metadata fields may be null; empty spine is valid", () => {
    const value = {
      ...
      content: {
        metadata: { title: null, creator: null, date: null },
        spine: [],
        manifest: [],
        spineHashes: [],
        toc: [],
